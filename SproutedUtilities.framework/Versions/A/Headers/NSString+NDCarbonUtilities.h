...
// PDAddition
/*!
	@method getFSCatalogInfo:
	@abstract Get a <tt>FSCatalogInfo</tt>.
	@discussion Obtain a <tt>FSCatalogInfo</tt> for a POSIX path.
	@param aFSCatalogInfo A pointer to a <tt>FSCatalogInfo</tt> struct, to be filled by the method.
	@result Returns <tt>YES</tt> if successful, if the method returns <tt>NO</tt> then <tt>FSCatalogInfo</tt> contains garbage.
 */
