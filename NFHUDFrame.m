...
- (void)_drawTitleStringIn:(struct _NSRect)fp8 withColor:(id)fp24
{
	...
	NSRect targetFrame = NSMakeRect( fp8.size.width/2 - stringSize.width/2 ,fp8.origin.y, stringSize.width, fp8.size.height);
	
	[[self title] drawInRect:targetFrame withAttributes:attributes];
}
*/
